...
export class EtudiantLayoutComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { label: 'Cours', path: '/etudiant/cours', description: 'Mes cours et ressources' },
    { label: 'Notes', path: '/etudiant/notes', description: 'Suivre mes evaluations' },
    { label: 'Sessions', path: '/etudiant/sessions', description: 'Planning des seances' }
  ];
}
